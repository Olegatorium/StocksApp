...
namespace StocksApp.ViewComponents
{
    public class SelectedStockViewComponent : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync(string? stockSymbol)
        {
            ...
            if (stockSymbol != null)
            {
                companyProfileDict = await _finnhubService.GetStockInformation(stockSymbol, "CompanyProfile");
                var stockPriceDict = await _finnhubService.GetStockInformation(stockSymbol, "StockPriceQuote");
